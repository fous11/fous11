...
Мне 19, я завершаю обучение в колледже и специализируюсь на создании современных веб-приложений. Имею опыт лидерства в команде и базовые знания в разработке сайтов, приложений и баз данных.
...
Я выступал в роли **капитана команды** по разработке игры, что подтверждено сертификатом компетенций:
*   **Management:** Успешное распределение задач и контроль сроков.
*   **Mentoring:** Помощь участникам команды в освоении стека технологий.
*   **Communication:** Эффективное взаимодействие внутри команды и успешная защита продукта.

---

## Как со мной связаться
*   **Email:** Ilyabiz-work@yandex.ru
*   **Telegram:** @fous11
